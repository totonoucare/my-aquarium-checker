window.AQUA_RAKUTEN_RECIPES = {
  "recipes": {
    "tank_20": {
      "label": "小型水槽 20cm前後",
      "category": "水槽",
      "query": "ガラス水槽 20cm アクアリウム",
      "ng": "中古 訳あり 金魚鉢 メダカ鉢 プラケース 虫かご",
      "minPrice": 900,
      "maxPrice": 6500,
    ...
    "tank_30": {
      "label": "水槽 30cm前後",
      "category": "水槽",
      "query": "30cm 水槽 ガラス アクアリウム",
      "ng": "中古 訳あり 金魚鉢 メダカ鉢 セット フィルター付き",
      "minPrice": 1500,
      "maxPrice": 9000,
    ...
    "filter_low_flow": {
      "label": "弱水流フィルター",
      "category": "フィルター",
      "query": "ベタ 水流 弱い フィルター 水槽",
      "ng": "中古 訳あり 交換用 ろ材のみ カートリッジのみ 部品",
      "minPrice": 700,
      "maxPrice": 5000,
    ...
    "filter_medium": {
      "label": "45〜60cm向けフィルター",
      "category": "フィルター",
      "query": "45cm 60cm 水槽 フィルター 外掛け 静音",
      "ng": "中古 訳あり 交換用 ろ材のみ カートリッジのみ 部品",
      "minPrice": 1200,
      "maxPrice": 9000,
    ...
    "heater_betta": {
      "label": "ベタ・小型水槽ヒーター",
      "category": "ヒーター",
      "query": "ベタ ヒーター 小型水槽 オートヒーター",
      "ng": "中古 訳あり 爬虫類 部品 カバーのみ",
      "minPrice": 900,
      "maxPrice": 6500,
    ...
    "heater_30": {
      "label": "30cm水槽ヒーター",
      "category": "ヒーター",
      "query": "30cm 水槽 ヒーター オートヒーター 熱帯魚",
      "ng": "中古 訳あり 爬虫類 部品 カバーのみ",
      "minPrice": 1200,
      "maxPrice": 7000,
    ...
    "bacteria": {
      "label": "バクテリア剤",
      "category": "水質・管理",
      "query": "水槽 バクテリア剤 立ち上げ 淡水",
      "ng": "中古 訳あり 海水専用 詰め替え 空容器",
      "minPrice": 500,
      "maxPrice": 3000,
    ...
    "cleaner_small": {
      "label": "小型水槽 掃除用品",
      "category": "掃除",
      "query": "小型水槽 掃除 水換え ポンプ クリーナー",
      "ng": "中古 訳あり 業務用 部品 交換用",
      "minPrice": 500,
      "maxPrice": 3500,
    ...
    "led_small": {
      "label": "小型水槽LED",
      "category": "ライト",
      "query": "30cm 水槽 LEDライト アクアリウム",
      "ng": "中古 訳あり 部品 交換用 爬虫類",
      "minPrice": 1000,
      "maxPrice": 7000,
    ...
    "led_45_60": {
      "label": "45〜60cm水槽LED",
      "category": "ライト",
      "query": "45cm 60cm 水槽 LEDライト アクアリウム",
      "ng": "中古 訳あり 部品 交換用 爬虫類",
      "minPrice": 2500,
      "maxPrice": 12000,
    ...
    "bottom_sand": {
      "label": "底砂・ソイル",
      "category": "レイアウト",
      "query": "水槽 底砂 ソイル 初心者 淡水",
      "ng": "中古 訳あり 海水 サンゴ砂 メダカ鉢",
      "minPrice": 600,
      "maxPrice": 3500,
    ...
    "food_tropical": {
      "label": "小型熱帯魚の餌",
      "category": "餌",
      "query": "小型熱帯魚 餌 フード テトラ グッピー",
      "ng": "中古 訳あり 大型魚 金魚 鯉 冷凍",
      "minPrice": 250,
      "maxPrice": 1800,
  ...
  "plans": {
    "betta": {
      "title": "ベタ単独水槽",
      "subtitle": "1匹をじっくり眺める。水流弱め・水温管理・隠れ家重視。",
      "fishImage": "/assets/media/fish/betta.webp",
      "fishIds": [
        "live_betta"
      ],
      "warnings": [
        "ベタは基本単独飼育。強い水流と急な水温低下に注意。",
        "小型水槽でもヒーター対応水量は必ず確認してください。"
      ],
      "tiers": {
        "low": [
          "tank_20",
    ...
    "guppy": {
      "title": "グッピー・プラティ入門水槽",
      "subtitle": "色味を楽しみたい人向け。繁殖しやすさと水質管理に注意。",
      "fishImage": "/assets/media/fish/guppy.webp",
      "fishIds": [
        "live_guppy"
      ],
      "fishCategoryIds": [
    ...
    "shrimp": {
      "title": "エビ・水草ミニ水槽",
      "subtitle": "ミナミヌマエビや水草を楽しむ。農薬・水質変化に注意。",
    ...
    "medaka": {
      "title": "ヒーターなし候補：室内メダカ水槽",
      "subtitle": "ヒーターを避けたい人向け。室温変化・夏の高温にも注意。",
      "fishImage": "/assets/media/fish/medaka.webp",
      "fishIds": [
        "live_medaka"
      ],
      "fishCategoryIds": [
    ...
    "community60": {
      "title": "60cmコミュニティ水槽",
      "subtitle": "魚数やレイアウトの余裕を取りたい人向け。置き場所と初期費用は重め。",
