...
function renderGearForPlan(key) {
  const plans = {
    shoal: [
      ["30cm〜45cm水槽セット", "ネオンテトラ・ラスボラなどの小型群泳向け。余裕を見たいなら45cmも候補。", "/comparison/?section=starter"],
      ["外掛けフィルター", "小型水槽でも使いやすく、初心者が管理しやすいタイプ。", "/comparison/?section=filter"],
      ["水温計・カルキ抜き", "水温確認と水道水処理は最初から用意しておきたい基本用品。", "/comparison/?section=care"],
      ["熱帯魚の餌", "小型魚向けのフードを選ぶと使いやすいです。", "/comparison/?section=food"]
    ],
    colorful: [
      ["45cm水槽セット", "グッピー・プラティなどを少し余裕を持って飼いやすいサイズ。", "/comparison/?section=starter"],
      ["40〜60cm向けフィルター", "魚数が増えやすいタイプは、ろ過に余裕を持つと安心。", "/comparison/?section=filter"],
      ["水換え・掃除用品", "にぎやかな水槽ほど定期的な掃除が大事になります。", "/comparison/?section=care"],
      ["熱帯魚の餌", "浮くタイプ・沈むタイプを生体に合わせて選びます。", "/comparison/?section=food"]
    ],
    solo: [
      ["ベタ用水槽セット", "ベタを単独でじっくり楽しみたい人向け。フタつきだと安心。", "/comparison/?section=starter"],
      ["水温計・カルキ抜き", "小型水槽ほど水温変化が出やすいので確認しやすく。", "/comparison/?section=care"],
      ["ヒーター", "ベタは保温が必要になりやすいので、対応水量と安全機能を確認。", "/comparison/?section=heater"],
      ["水作系フィルター", "水流が強すぎない構成を選びたいタイプ。", "/comparison/?section=filter"],
      ["隠れ家・レイアウト", "ベタが落ち着ける隠れ場所や、見た目のアクセントに。", "/comparison/?section=layout"]
    ],
    shrimp: [
      ["30cm水槽セット", "エビ・水草・小型魚を少なめに楽しむ入門サイズ。", "/comparison/?section=starter"],
      ["水作系フィルター", "稚エビを吸い込みにくい構成を意識したい水槽向け。", "/comparison/?section=filter"],
      ["LEDライト", "水草も楽しむならライトがあると見た目も管理もしやすいです。", "/comparison/?section=light"],
      ["底もの・エビ向け餌", "エビや底ものに届きやすい沈む餌が便利です。", "/comparison/?section=food"],
      ["隠れ家・レイアウト", "エビや小型魚の隠れ場所を作りたい場合に。", "/comparison/?section=layout"]
    ],
    easy: [
      ["30cm水槽セット", "アカヒレ・メダカなど、シンプルに始めたい人向け。", "/comparison/?section=starter"],
      ["カルキ抜き・水温計", "ヒーターなし構成でも水温確認と水道水処理は必要です。", "/comparison/?section=care"],
      ["掃除用品", "水換えを楽にできる道具があると続けやすくなります。", "/comparison/?section=care"],
      ["フィルター", "水を安定させるために、小型水槽でも用意しておきたい用品。", "/comparison/?section=filter"]
    ]
  };
